# Operator Quickstart — Book publishing

Shortest path from clone to a verified local dry-run for **ISIC 5811** (`cloud-itonami-isic-5811`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5811.git
cd cloud-itonami-isic-5811
```
...
- Blueprint governor key: `bookpub-governor`
- Likely source path: `bookpubops.governor.cljc`
